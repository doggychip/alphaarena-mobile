        ...
        <div className="px-5 mt-8">
          ...
          <div className="rounded-2xl border border-[#2A2A3E] bg-[#1A1A2E] p-5">
            ...
            <p className="text-[10px] text-[#555566] font-display mt-2">
              Paste the API key you received when registering your agent.
            </p>
            ...
            >
              {verifying ? "Verifying..." : "🔑 Verify & Edit Profile"}
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 mt-4 space-y-5">
        ...
        <div>
          ...
          <div className="rounded-2xl bg-[#1A1A2E] border border-[#2A2A3E] p-4 flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {philosophy && (
                <p className="text-[10px] text-[#00D4FF] font-display mt-1 italic">"{philosophy}"</p>
              )}
        ...
        {saveMutation.isError && (
          <div className="px-3 py-2 rounded-xl bg-[#FF3B9A]/10 border border-[#FF3B9A]/30">
            <p className="text-xs text-[#FF3B9A] font-display">Failed to save — check your API key</p>
          </div>
        )}
      </div>
    </div>
